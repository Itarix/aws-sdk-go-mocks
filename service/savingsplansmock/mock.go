...
// ReturnSavingsPlan mocks base method
func (m *MockSavingsPlansAPI) ReturnSavingsPlan(arg0 *savingsplans.ReturnSavingsPlanInput) (*savingsplans.ReturnSavingsPlanOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReturnSavingsPlan", arg0)
	ret0, _ := ret[0].(*savingsplans.ReturnSavingsPlanOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReturnSavingsPlan indicates an expected call of ReturnSavingsPlan
func (mr *MockSavingsPlansAPIMockRecorder) ReturnSavingsPlan(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReturnSavingsPlan", reflect.TypeOf((*MockSavingsPlansAPI)(nil).ReturnSavingsPlan), arg0)
}

// ReturnSavingsPlanRequest mocks base method
func (m *MockSavingsPlansAPI) ReturnSavingsPlanRequest(arg0 *savingsplans.ReturnSavingsPlanInput) (*request.Request, *savingsplans.ReturnSavingsPlanOutput) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReturnSavingsPlanRequest", arg0)
	ret0, _ := ret[0].(*request.Request)
	ret1, _ := ret[1].(*savingsplans.ReturnSavingsPlanOutput)
	return ret0, ret1
}

// ReturnSavingsPlanRequest indicates an expected call of ReturnSavingsPlanRequest
func (mr *MockSavingsPlansAPIMockRecorder) ReturnSavingsPlanRequest(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReturnSavingsPlanRequest", reflect.TypeOf((*MockSavingsPlansAPI)(nil).ReturnSavingsPlanRequest), arg0)
}

// ReturnSavingsPlanWithContext mocks base method
func (m *MockSavingsPlansAPI) ReturnSavingsPlanWithContext(arg0 context.Context, arg1 *savingsplans.ReturnSavingsPlanInput, arg2 ...request.Option) (*savingsplans.ReturnSavingsPlanOutput, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "ReturnSavingsPlanWithContext", varargs...)
	ret0, _ := ret[0].(*savingsplans.ReturnSavingsPlanOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ReturnSavingsPlanWithContext indicates an expected call of ReturnSavingsPlanWithContext
func (mr *MockSavingsPlansAPIMockRecorder) ReturnSavingsPlanWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReturnSavingsPlanWithContext", reflect.TypeOf((*MockSavingsPlansAPI)(nil).ReturnSavingsPlanWithContext), varargs...)
}
