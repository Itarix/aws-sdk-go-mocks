...
// DetectToxicContent mocks base method
func (m *MockComprehendAPI) DetectToxicContent(arg0 *comprehend.DetectToxicContentInput) (*comprehend.DetectToxicContentOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DetectToxicContent", arg0)
	ret0, _ := ret[0].(*comprehend.DetectToxicContentOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DetectToxicContent indicates an expected call of DetectToxicContent
func (mr *MockComprehendAPIMockRecorder) DetectToxicContent(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DetectToxicContent", reflect.TypeOf((*MockComprehendAPI)(nil).DetectToxicContent), arg0)
}

// DetectToxicContentRequest mocks base method
func (m *MockComprehendAPI) DetectToxicContentRequest(arg0 *comprehend.DetectToxicContentInput) (*request.Request, *comprehend.DetectToxicContentOutput) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DetectToxicContentRequest", arg0)
	ret0, _ := ret[0].(*request.Request)
	ret1, _ := ret[1].(*comprehend.DetectToxicContentOutput)
	return ret0, ret1
}

// DetectToxicContentRequest indicates an expected call of DetectToxicContentRequest
func (mr *MockComprehendAPIMockRecorder) DetectToxicContentRequest(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DetectToxicContentRequest", reflect.TypeOf((*MockComprehendAPI)(nil).DetectToxicContentRequest), arg0)
}

// DetectToxicContentWithContext mocks base method
func (m *MockComprehendAPI) DetectToxicContentWithContext(arg0 context.Context, arg1 *comprehend.DetectToxicContentInput, arg2 ...request.Option) (*comprehend.DetectToxicContentOutput, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "DetectToxicContentWithContext", varargs...)
	ret0, _ := ret[0].(*comprehend.DetectToxicContentOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DetectToxicContentWithContext indicates an expected call of DetectToxicContentWithContext
func (mr *MockComprehendAPIMockRecorder) DetectToxicContentWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DetectToxicContentWithContext", reflect.TypeOf((*MockComprehendAPI)(nil).DetectToxicContentWithContext), varargs...)
}
