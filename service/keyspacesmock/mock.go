...
// GetTableAutoScalingSettings mocks base method
func (m *MockKeyspacesAPI) GetTableAutoScalingSettings(arg0 *keyspaces.GetTableAutoScalingSettingsInput) (*keyspaces.GetTableAutoScalingSettingsOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTableAutoScalingSettings", arg0)
	ret0, _ := ret[0].(*keyspaces.GetTableAutoScalingSettingsOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTableAutoScalingSettings indicates an expected call of GetTableAutoScalingSettings
func (mr *MockKeyspacesAPIMockRecorder) GetTableAutoScalingSettings(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTableAutoScalingSettings", reflect.TypeOf((*MockKeyspacesAPI)(nil).GetTableAutoScalingSettings), arg0)
}

// GetTableAutoScalingSettingsRequest mocks base method
func (m *MockKeyspacesAPI) GetTableAutoScalingSettingsRequest(arg0 *keyspaces.GetTableAutoScalingSettingsInput) (*request.Request, *keyspaces.GetTableAutoScalingSettingsOutput) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTableAutoScalingSettingsRequest", arg0)
	ret0, _ := ret[0].(*request.Request)
	ret1, _ := ret[1].(*keyspaces.GetTableAutoScalingSettingsOutput)
	return ret0, ret1
}

// GetTableAutoScalingSettingsRequest indicates an expected call of GetTableAutoScalingSettingsRequest
func (mr *MockKeyspacesAPIMockRecorder) GetTableAutoScalingSettingsRequest(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTableAutoScalingSettingsRequest", reflect.TypeOf((*MockKeyspacesAPI)(nil).GetTableAutoScalingSettingsRequest), arg0)
}

// GetTableAutoScalingSettingsWithContext mocks base method
func (m *MockKeyspacesAPI) GetTableAutoScalingSettingsWithContext(arg0 context.Context, arg1 *keyspaces.GetTableAutoScalingSettingsInput, arg2 ...request.Option) (*keyspaces.GetTableAutoScalingSettingsOutput, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GetTableAutoScalingSettingsWithContext", varargs...)
	ret0, _ := ret[0].(*keyspaces.GetTableAutoScalingSettingsOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTableAutoScalingSettingsWithContext indicates an expected call of GetTableAutoScalingSettingsWithContext
func (mr *MockKeyspacesAPIMockRecorder) GetTableAutoScalingSettingsWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTableAutoScalingSettingsWithContext", reflect.TypeOf((*MockKeyspacesAPI)(nil).GetTableAutoScalingSettingsWithContext), varargs...)
}
