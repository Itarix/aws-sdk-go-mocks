...
// UpdateRepositoryEncryptionKey mocks base method
func (m *MockCodeCommitAPI) UpdateRepositoryEncryptionKey(arg0 *codecommit.UpdateRepositoryEncryptionKeyInput) (*codecommit.UpdateRepositoryEncryptionKeyOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateRepositoryEncryptionKey", arg0)
	ret0, _ := ret[0].(*codecommit.UpdateRepositoryEncryptionKeyOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateRepositoryEncryptionKey indicates an expected call of UpdateRepositoryEncryptionKey
func (mr *MockCodeCommitAPIMockRecorder) UpdateRepositoryEncryptionKey(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateRepositoryEncryptionKey", reflect.TypeOf((*MockCodeCommitAPI)(nil).UpdateRepositoryEncryptionKey), arg0)
}

// UpdateRepositoryEncryptionKeyRequest mocks base method
func (m *MockCodeCommitAPI) UpdateRepositoryEncryptionKeyRequest(arg0 *codecommit.UpdateRepositoryEncryptionKeyInput) (*request.Request, *codecommit.UpdateRepositoryEncryptionKeyOutput) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateRepositoryEncryptionKeyRequest", arg0)
	ret0, _ := ret[0].(*request.Request)
	ret1, _ := ret[1].(*codecommit.UpdateRepositoryEncryptionKeyOutput)
	return ret0, ret1
}

// UpdateRepositoryEncryptionKeyRequest indicates an expected call of UpdateRepositoryEncryptionKeyRequest
func (mr *MockCodeCommitAPIMockRecorder) UpdateRepositoryEncryptionKeyRequest(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateRepositoryEncryptionKeyRequest", reflect.TypeOf((*MockCodeCommitAPI)(nil).UpdateRepositoryEncryptionKeyRequest), arg0)
}

// UpdateRepositoryEncryptionKeyWithContext mocks base method
func (m *MockCodeCommitAPI) UpdateRepositoryEncryptionKeyWithContext(arg0 context.Context, arg1 *codecommit.UpdateRepositoryEncryptionKeyInput, arg2 ...request.Option) (*codecommit.UpdateRepositoryEncryptionKeyOutput, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "UpdateRepositoryEncryptionKeyWithContext", varargs...)
	ret0, _ := ret[0].(*codecommit.UpdateRepositoryEncryptionKeyOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UpdateRepositoryEncryptionKeyWithContext indicates an expected call of UpdateRepositoryEncryptionKeyWithContext
func (mr *MockCodeCommitAPIMockRecorder) UpdateRepositoryEncryptionKeyWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateRepositoryEncryptionKeyWithContext", reflect.TypeOf((*MockCodeCommitAPI)(nil).UpdateRepositoryEncryptionKeyWithContext), varargs...)
}
