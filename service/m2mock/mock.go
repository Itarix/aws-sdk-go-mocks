...
// ListBatchJobRestartPoints mocks base method
func (m *MockM2API) ListBatchJobRestartPoints(arg0 *m2.ListBatchJobRestartPointsInput) (*m2.ListBatchJobRestartPointsOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListBatchJobRestartPoints", arg0)
	ret0, _ := ret[0].(*m2.ListBatchJobRestartPointsOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListBatchJobRestartPoints indicates an expected call of ListBatchJobRestartPoints
func (mr *MockM2APIMockRecorder) ListBatchJobRestartPoints(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListBatchJobRestartPoints", reflect.TypeOf((*MockM2API)(nil).ListBatchJobRestartPoints), arg0)
}

// ListBatchJobRestartPointsRequest mocks base method
func (m *MockM2API) ListBatchJobRestartPointsRequest(arg0 *m2.ListBatchJobRestartPointsInput) (*request.Request, *m2.ListBatchJobRestartPointsOutput) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListBatchJobRestartPointsRequest", arg0)
	ret0, _ := ret[0].(*request.Request)
	ret1, _ := ret[1].(*m2.ListBatchJobRestartPointsOutput)
	return ret0, ret1
}

// ListBatchJobRestartPointsRequest indicates an expected call of ListBatchJobRestartPointsRequest
func (mr *MockM2APIMockRecorder) ListBatchJobRestartPointsRequest(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListBatchJobRestartPointsRequest", reflect.TypeOf((*MockM2API)(nil).ListBatchJobRestartPointsRequest), arg0)
}

// ListBatchJobRestartPointsWithContext mocks base method
func (m *MockM2API) ListBatchJobRestartPointsWithContext(arg0 context.Context, arg1 *m2.ListBatchJobRestartPointsInput, arg2 ...request.Option) (*m2.ListBatchJobRestartPointsOutput, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "ListBatchJobRestartPointsWithContext", varargs...)
	ret0, _ := ret[0].(*m2.ListBatchJobRestartPointsOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListBatchJobRestartPointsWithContext indicates an expected call of ListBatchJobRestartPointsWithContext
func (mr *MockM2APIMockRecorder) ListBatchJobRestartPointsWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListBatchJobRestartPointsWithContext", reflect.TypeOf((*MockM2API)(nil).ListBatchJobRestartPointsWithContext), varargs...)
}
