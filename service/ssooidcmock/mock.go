...
// CreateTokenWithIAM mocks base method
func (m *MockSSOOIDCAPI) CreateTokenWithIAM(arg0 *ssooidc.CreateTokenWithIAMInput) (*ssooidc.CreateTokenWithIAMOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTokenWithIAM", arg0)
	ret0, _ := ret[0].(*ssooidc.CreateTokenWithIAMOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateTokenWithIAM indicates an expected call of CreateTokenWithIAM
func (mr *MockSSOOIDCAPIMockRecorder) CreateTokenWithIAM(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTokenWithIAM", reflect.TypeOf((*MockSSOOIDCAPI)(nil).CreateTokenWithIAM), arg0)
}

// CreateTokenWithIAMRequest mocks base method
func (m *MockSSOOIDCAPI) CreateTokenWithIAMRequest(arg0 *ssooidc.CreateTokenWithIAMInput) (*request.Request, *ssooidc.CreateTokenWithIAMOutput) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTokenWithIAMRequest", arg0)
	ret0, _ := ret[0].(*request.Request)
	ret1, _ := ret[1].(*ssooidc.CreateTokenWithIAMOutput)
	return ret0, ret1
}

// CreateTokenWithIAMRequest indicates an expected call of CreateTokenWithIAMRequest
func (mr *MockSSOOIDCAPIMockRecorder) CreateTokenWithIAMRequest(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTokenWithIAMRequest", reflect.TypeOf((*MockSSOOIDCAPI)(nil).CreateTokenWithIAMRequest), arg0)
}

// CreateTokenWithIAMWithContext mocks base method
func (m *MockSSOOIDCAPI) CreateTokenWithIAMWithContext(arg0 context.Context, arg1 *ssooidc.CreateTokenWithIAMInput, arg2 ...request.Option) (*ssooidc.CreateTokenWithIAMOutput, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "CreateTokenWithIAMWithContext", varargs...)
	ret0, _ := ret[0].(*ssooidc.CreateTokenWithIAMOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateTokenWithIAMWithContext indicates an expected call of CreateTokenWithIAMWithContext
func (mr *MockSSOOIDCAPIMockRecorder) CreateTokenWithIAMWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateTokenWithIAMWithContext", reflect.TypeOf((*MockSSOOIDCAPI)(nil).CreateTokenWithIAMWithContext), varargs...)
}
