...
func (m *MockBatchAPI) GetJobQueueSnapshot(arg0 *batch.GetJobQueueSnapshotInput) (*batch.GetJobQueueSnapshotOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetJobQueueSnapshot", arg0)
...
func (mr *MockBatchAPIMockRecorder) GetJobQueueSnapshot(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetJobQueueSnapshot", reflect.TypeOf((*MockBatchAPI)(nil).GetJobQueueSnapshot), arg0)
}

// GetJobQueueSnapshotRequest mocks base method
func (m *MockBatchAPI) GetJobQueueSnapshotRequest(arg0 *batch.GetJobQueueSnapshotInput) (*request.Request, *batch.GetJobQueueSnapshotOutput) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetJobQueueSnapshotRequest", arg0)
	ret0, _ := ret[0].(*request.Request)
	ret1, _ := ret[1].(*batch.GetJobQueueSnapshotOutput)
	return ret0, ret1
}

// GetJobQueueSnapshotRequest indicates an expected call of GetJobQueueSnapshotRequest
func (mr *MockBatchAPIMockRecorder) GetJobQueueSnapshotRequest(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetJobQueueSnapshotRequest", reflect.TypeOf((*MockBatchAPI)(nil).GetJobQueueSnapshotRequest), arg0)
}

// GetJobQueueSnapshotWithContext mocks base method
func (m *MockBatchAPI) GetJobQueueSnapshotWithContext(arg0 context.Context, arg1 *batch.GetJobQueueSnapshotInput, arg2 ...request.Option) (*batch.GetJobQueueSnapshotOutput, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "GetJobQueueSnapshotWithContext", varargs...)
	ret0, _ := ret[0].(*batch.GetJobQueueSnapshotOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetJobQueueSnapshotWithContext indicates an expected call of GetJobQueueSnapshotWithContext
func (mr *MockBatchAPIMockRecorder) GetJobQueueSnapshotWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetJobQueueSnapshotWithContext", reflect.TypeOf((*MockBatchAPI)(nil).GetJobQueueSnapshotWithContext), varargs...)
}
