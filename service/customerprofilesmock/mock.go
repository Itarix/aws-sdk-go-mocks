...
// DetectProfileObjectType mocks base method
func (m *MockCustomerProfilesAPI) DetectProfileObjectType(arg0 *customerprofiles.DetectProfileObjectTypeInput) (*customerprofiles.DetectProfileObjectTypeOutput, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DetectProfileObjectType", arg0)
	ret0, _ := ret[0].(*customerprofiles.DetectProfileObjectTypeOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DetectProfileObjectType indicates an expected call of DetectProfileObjectType
func (mr *MockCustomerProfilesAPIMockRecorder) DetectProfileObjectType(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DetectProfileObjectType", reflect.TypeOf((*MockCustomerProfilesAPI)(nil).DetectProfileObjectType), arg0)
}

// DetectProfileObjectTypeRequest mocks base method
func (m *MockCustomerProfilesAPI) DetectProfileObjectTypeRequest(arg0 *customerprofiles.DetectProfileObjectTypeInput) (*request.Request, *customerprofiles.DetectProfileObjectTypeOutput) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DetectProfileObjectTypeRequest", arg0)
	ret0, _ := ret[0].(*request.Request)
	ret1, _ := ret[1].(*customerprofiles.DetectProfileObjectTypeOutput)
	return ret0, ret1
}

// DetectProfileObjectTypeRequest indicates an expected call of DetectProfileObjectTypeRequest
func (mr *MockCustomerProfilesAPIMockRecorder) DetectProfileObjectTypeRequest(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DetectProfileObjectTypeRequest", reflect.TypeOf((*MockCustomerProfilesAPI)(nil).DetectProfileObjectTypeRequest), arg0)
}

// DetectProfileObjectTypeWithContext mocks base method
func (m *MockCustomerProfilesAPI) DetectProfileObjectTypeWithContext(arg0 context.Context, arg1 *customerprofiles.DetectProfileObjectTypeInput, arg2 ...request.Option) (*customerprofiles.DetectProfileObjectTypeOutput, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "DetectProfileObjectTypeWithContext", varargs...)
	ret0, _ := ret[0].(*customerprofiles.DetectProfileObjectTypeOutput)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// DetectProfileObjectTypeWithContext indicates an expected call of DetectProfileObjectTypeWithContext
func (mr *MockCustomerProfilesAPIMockRecorder) DetectProfileObjectTypeWithContext(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DetectProfileObjectTypeWithContext", reflect.TypeOf((*MockCustomerProfilesAPI)(nil).DetectProfileObjectTypeWithContext), varargs...)
}
